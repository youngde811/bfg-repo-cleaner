...
import com.madgag.git.gitclean.cleaner.ObjectIdCleaner
 ...
 * to protect in their latest commits - it's the stuff Gitclean would remove if you hadn't told it to
 * hold back.
 *
